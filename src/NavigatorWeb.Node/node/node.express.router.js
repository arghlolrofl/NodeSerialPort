...
var thing_route_collection_1 = require('./routes/thing.route.collection');
var NodeExpressRouter = (function () {
    ...
    NodeExpressRouter.prototype.AddApiRoutes = function () {
        var thingRoutes = new thing_route_collection_1.ThingRouteCollection(this.app);
        this.app = thingRoutes.ApplyRoutes();
    };
    return NodeExpressRouter;
}());
exports.NodeExpressRouter = NodeExpressRouter;
//# sourceMappingURL=node.express.router.js.map